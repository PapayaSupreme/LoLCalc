...
public:
    /*
     * Damage constructor with ratios and damage ranges
     */
    ...
    /*
     * Damage constructor with adaptive damage and damage ranges
     */
    Damage(std::string name, EffectTrigger effect_trigger, float base_damage, std::vector<Ratio> terms, float min_damage, float max_damage,
    float max_monster_damage, float max_epic_monster_damage);
    /*
     * Damage constructor with ratios
     */
    Damage(std::string name, EffectTrigger effect_trigger, float base_damage, std::vector<Ratio> terms,
    float physical_ratio, float magical_ratio, float true_ratio);
    /*
     * Damage constructor with adaptive damage
     */
    Damage(std::string name, EffectTrigger effect_trigger, float base_damage, std::vector<Ratio> terms);
