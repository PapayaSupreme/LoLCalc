...
DamageDone DoTAbility::computePremitigationDamage() const{
    DamageDone dmg = {0.0f, 0.0f, 0.0f};
    float damage_dealt = this->dot_ability_stats.base_damage + source.getAD() * this->dot_ability_stats.AD_ratio
